...
working_directory = r"E:\20221007_DSD18\Raw Files"
output_directory = r"D:\Manuscripts\2022_DIA\Data\DSD_20221009_files\RawConverter_Output_Formatted"
...
for a in ion_file:
    ...
    new_list= []
    final_lst = []
    final_lst.append(['m/z', 'Resolution', 'Charge', 'Intensity', 'MS2','Scan_Number','Precursor_Charge', 'Ion_Injection_Time'])
    ...
    SIM_result['IT'] = SIM_result_imp['Ion_Injection_Time']
