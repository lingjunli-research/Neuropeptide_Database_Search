...
for file_category in raw_conv_mzml_storage:
  ...
  #%%  
    ...
    db_sorted_filtered = fasta_w_mass.drop_duplicates(subset='Precursor theoretical monoisotopic mass')
    ...
    for a in range(0,len(db_sorted_filtered)):
        ...
        mass = db_filtered['Precursor theoretical monoisotopic mass'][0]
        mass_storage.append(mass)
        ...
        time_storage.append(finish_loop-start_loop)
    ...
    merge_match_merge_again = pd.merge(merge_match, fasta_w_mass, on='Precursor theoretical monoisotopic mass', how='inner')
    ...
    time_analysis_df['Mass'] = mass_storage
    time_analysis_df['Time'] = time_storage