...
for file_category in raw_conv_mzml_storage:
  ...
  #%%  
    ...
    #db_single_masses = fasta_w_mass.drop_duplicates(subset='Precursor theoretical monoisotopic mass')
    db_mass_only = pd.DataFrame()
    db_mass_only['Precursor theoretical monoisotopic mass'] = fasta_w_mass['Precursor theoretical monoisotopic mass']
    db_mass_only['Sequence'] = fasta_w_mass['Sequence']
    
    exp_mass_only = pd.DataFrame()
    exp_mass_only['Precursor actual monoisotopic mass'] = exp_precursor['Precursor actual monoisotopic mass']
    exp_mass_only['Scan'] = exp_precursor['Scan']

    

    db_mass_only = db_mass_only[db_mass_only['Precursor theoretical monoisotopic mass'] > 966.526]
    db_mass_only = db_mass_only[db_mass_only['Precursor theoretical monoisotopic mass'] < 966.528]
    ...
    # exp_precursor_sorted = exp_precursor_sorted.drop_duplicates(subset = ['Precursor actual monoisotopic mass','Scan'])
    
    db_sorted_filtered = db_sorted.drop_duplicates(subset='Precursor theoretical monoisotopic mass')
    ...
    merge_match_merge_again = pd.merge(merge_match, db_sorted, on='Precursor theoretical monoisotopic mass', how='inner')
