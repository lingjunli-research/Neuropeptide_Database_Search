# -*- coding: utf-8 -*-
"""
Created on Mon May 15 16:11:20 2023
...
##User input##
output_parent_directory = r"C:\Users\lawashburn\Documents\DBpep_v2\finale_weighting_hyperscore\weighting_input_data\database_search_out_fast_hyperscore\20230515_v02" #folder in which all output directories will be generated
...
for file_category in raw_conv_mzml_storage:
    ...
    def param_log_export(output_folder,sample_name):
        ...
        param_file_entries = [out_path_report,rawconverter_path_report,db_path_report,sample_ID_report,p_err_report,f_err_report,max_p_charge_report,max_f_charge_report,
                              no_steps_report,max_modifications_report,amidation_modifications_report,oxidation_M_status_modifications_report,
